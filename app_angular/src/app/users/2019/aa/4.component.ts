...
import { udata_2019_4 } from '../../../_data/2019';
...
export class Aa20194Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2019_4, prefix);
