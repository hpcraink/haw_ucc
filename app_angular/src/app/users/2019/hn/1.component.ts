...
import { udata_2019_1 } from '../../../_data/2019';
...
export class Hn20191Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2019_1, prefix);
