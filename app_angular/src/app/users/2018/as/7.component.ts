...
import { udata_2018_7 } from '../../../_data/2018';
...
export class As20187Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2018_7, prefix);
