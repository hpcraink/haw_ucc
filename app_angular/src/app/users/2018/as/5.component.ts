...
import { udata_2018_5 } from '../../../_data/2018';
...
export class As20185Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2018_5, prefix);
