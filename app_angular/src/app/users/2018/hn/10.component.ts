...
import { udata_2018_10 } from '../../../_data/2018';

const prefix:string = 'hn'
const Data = new DataObject();

@Component({
  templateUrl: '10.component.html'
})
export class Hn201810Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2018_10, prefix);
