...
import { udata_2018_9 } from '../../../_data/2018';
...
export class Hu20189Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2018_9, prefix);
