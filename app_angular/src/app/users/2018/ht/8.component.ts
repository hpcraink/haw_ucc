...
import { udata_2018_8 } from '../../../_data/2018';
...
export class Ht20188Component implements OnInit {
  private TABLE_DATA = Data.uniData(udata_2018_8, prefix);
