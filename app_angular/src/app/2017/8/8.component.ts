...
import { uca_2017_08 } from '../../_helpers/bwUniData_2017';
import { months,
         total_uca_2017,
         pie_chart_opt
...
// get data
let data:any[] = [];
uca_2017_08.forEach( (row) => {
  data.push([row.prefix, row.cost]);
});

@Component({
  selector: 'data-2017-8',
  templateUrl: '8.component.html'
})
export class Month8Component {
  public year = 2017;
  public mnth:number = 8;
  public haw_data = uca_2017_08;
