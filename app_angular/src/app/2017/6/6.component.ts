...
import { uca_2017_06 } from '../../_helpers/bwUniData_2017';
import { months,
         total_uca_2017,
         pie_chart_opt
...
// get data
let data:any[] = [];
uca_2017_06.forEach( (row) => {
  data.push([row.prefix, row.cost]);
});

@Component({
  selector: 'data-2017-6',
  templateUrl: '6.component.html'
})
export class Month6Component {
  public year = 2017;
  public mnth:number = 6;
  public haw_data = uca_2017_06;
