...
import { uca_2018_11 } from '../../_helpers/bwUniData_2018';
import { months,
         total_uca_2018,
         pie_chart_opt
...
// get data
let data:any[] = [];
uca_2018_11.forEach( (row) => {
  data.push([row.prefix, row.cost]);
});

@Component({
  selector: 'data-2018-11',
  templateUrl: '11.component.html'
})
export class Month11Component {
  public year = 2018;
  public mnth:number = 11;
  public haw_data = uca_2018_11;
