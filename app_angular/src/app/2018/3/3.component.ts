...
import { uca_2018_03 } from '../../_helpers/bwUniData_2018';
import { months,
         total_uca_2018,
         pie_chart_opt
...
// get data
let data:any[] = [];
uca_2018_03.forEach( (row) => {
  data.push([row.prefix, row.cost]);
});

@Component({
  selector: 'data-2018-3',
  templateUrl: '3.component.html'
})
export class Month3Component {
  public year = 2018;
  public mnth:number = 3;
  public haw_data = uca_2018_03;
